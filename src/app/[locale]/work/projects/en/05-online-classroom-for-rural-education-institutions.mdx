...
summary: "Built this platform for the final project of HarvardX CS50's Web Programming with Python and Javascript program. Panthiya aims to utilize modern technology to create a platform for local students with low bandwidth to attend online classes provided by generous scholars."
images:
