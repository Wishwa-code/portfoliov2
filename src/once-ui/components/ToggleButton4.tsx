...
import { Icon } from '.';
import styles from './ToggleButton4.module.scss';
...
const ToggleButton4 = forwardRef<HTMLButtonElement | HTMLAnchorElement, ButtonProps | AnchorProps>(({
    label,
    selected,
    size = 'm',
    align = 'center',
...
ToggleButton4.displayName = "ToggleButton";

export { ToggleButton4 };